...
$lang_port = "Poort";
$lang_passive_mode = "Passieve modus (standaard)";
...
$lang_skins_empty = "[skins] map leeg!";
$lang_skins_locked = "[skins] map geblokkeerd!";
$lang_skins_missing = "[skins] map mist!";

$lang_missing_fields = "Fout! Vul alle gemarkeerde verplichte velden in";
...
$lang_table_time = "Tijd";
$lang_table_user = "Gebruiker";
$lang_table_group = "Groep";
$lang_table_perms = "Rechten";
...
$lang_btn_refresh = "Vernieuw";
$lang_btn_dl = "Download";
$lang_btn_cut = "Knip";
$lang_btn_copy = "Kopieer";
$lang_btn_paste = "Plak";
$lang_btn_rename = "Hernoem";
$lang_btn_delete = "Verwijder";
$lang_btn_chmod = "Chmod";
$lang_btn_logout = "Log uit";
...
$lang_btn_upload_files = "Upload bestanden";
...
$lang_xfer_progress = "Voortgang";
$lang_xfer_elapsed = "Tijd verstreken";
$lang_xfer_uploaded = "Geupload";
$lang_xfer_rate = "Dataoverdracht";
...
$lang_folder_cant_access = "Onmogelijk te benaderen [folder]";
$lang_folder_cant_make = "Onmogelijk te maken [folder]";

$lang_file_exists = "Bestand [file] bestaat al";
$lang_file_doesnt_exist = "Bestand [file] bestaat niet";
$lang_file_cant_move = "Onmogelijk te verplaatsen [file]";
$lang_file_cant_make = "Onmogelijk te maken [file]";

$lang_server_error_down = "Serverfout downloaden [file]";
$lang_server_error_up = "Serverfout uploaden [file]";
$lang_browser_error_up = "Browserfout uploaden [file]";
$lang_file_size_error = "Bestandsgrootte is meer dan toegestaan";
$lang_file_size_copy_error = "[file] grootte is meer dan toegestaan";

$lang_folder_cant_chmod = "Onmogelijke chmod [perms] [folder]";
$lang_file_cant_chmod = "Onmogelijke chmod [perms] [file]";
$lang_chmod_max_777 = "Chmod mag niet groter zijn dan 777";
$lang_chmod_owner = "Eigenaarsrechten";
$lang_chmod_group = "Groepsrechten";
$lang_chmod_public = "Publieke rechten";
$lang_chmod_manual = "Handleiding";
...
$lang_context_edit = "Wijzig";
$lang_context_cut = "Knip";
$lang_context_copy = "Kopieer";
$lang_context_paste = "Plak";
$lang_context_rename = "Hernoem";
