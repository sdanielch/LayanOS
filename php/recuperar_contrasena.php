...
<head>
    <meta charset="UTF-8">
    <title>LayanOS | Recuperar contraseña</title>
...
<body>
  <div id="login" style="text-align: justify;">
    ...
    ?>
    <b style="color: #FF4444; ">Reestablecer contraseña de usuario:</b></br>
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
            <label>Escriba su nombre de usuario para enviarle por email una nueva contraseña que le permita acceder a su cuenta:</label><br />
